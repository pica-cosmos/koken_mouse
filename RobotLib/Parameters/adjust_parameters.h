#ifndef ADJUST_PARAMETERS_H_
#define ADJUST_PARAMETERS_H_
...
#define TH_SEN_FR	50				//壁があるか否かの閾値	一区画前に壁が合ったときのセンサ値
#define TH_SEN_FL	50				//壁があるか否かの閾値  上と同様

//壁センサの偏差による目標角速度制御のパラメータ
#define CONTH_SEN_R	TH_SEN_R			//制御をかけるか否かの閾値（偏差として採用するかどうか）
#define CONTH_SEN_L	TH_SEN_L			//制御をかけるか否かの閾値（偏差として採用するかどうか）
