...
//For encoder
int enc_r_data = 0;
long long_enc_address = 0;
long long_enc_data = 0;
long dummy_long;
int dummy_spi_data;
int enc_r_address = 0;
int enc_write_cnt = 0;
...
void init_spi_enc(void)
{
	...
	*****************************************************************************************/
	...
	//RSPI0.SPCMD0.BIT.SPB =	 	0x0F;	//RSPIデータ長を16ビットに設定
	RSPI0.SPCMD0.BIT.SPB =	 	0x9;	//RSPIデータ長を10ビットに設定
...
void write_spdr_enc(void)
{
	...
	*****************************************************************************************/
	if(enc_write_cnt == 0){
		...
		//RSPI0.SPDR.LONG = 0x00000000;		//アドレス送信 
		//dummy read
		dummy_long = RSPI0.SPDR.LONG;
...
void read_spdr_enc(void)
{
	...
	*****************************************************************************************/
	...
	//long_enc_data = RSPI0.SPDR.LONG;	//データの読み込み
